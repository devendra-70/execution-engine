...
## **2.1 Service Boundaries** {#service-boundaries}
...
## **2.2 End-to-End Runtime Flow** {#end-to-end-runtime-flow}
...
# **3. Sub-Module 2.1 --- API Gateway Service** {#sub-module-2.1-api-gateway-service}
...
## **3.2 Responsibilities** {#responsibilities}
...
## **3.4 Request / Response Contracts** {#request-response-contracts}

### **POST /api/executions --- Request** {#post-apiexecutions-request}
...
### **POST /api/executions --- Response (202 Accepted)** {#post-apiexecutions-response-202-accepted}
...
### **WebSocket / STOMP Result Payload** {#websocket-stomp-result-payload}
...
## **3.5 Rate Limiting Design** {#rate-limiting-design}
...
## **3.6 Security Configuration** {#security-configuration}
...
# **4. Sub-Module 2.2 --- Execution Worker Service** {#sub-module-2.2-execution-worker-service}
...
## **4.2 Thread Pool Architecture** {#thread-pool-architecture}
...
## **4.3 Execution Orchestration** {#execution-orchestration}
...
## **4.4 Pre-Warmed Container Pool** {#pre-warmed-container-pool}
...
## **4.5 Result Publishing** {#result-publishing}
...
## **4.6 Kafka Consumer Configuration** {#kafka-consumer-configuration}
...
# **5. Sub-Module 2.3 --- Result Persistence Service** {#sub-module-2.3-result-persistence-service}
...
## **5.2 Responsibilities** {#responsibilities-1}
...
## **5.3 Database Schema** {#database-schema}
...
# **6. Sub-Module 2.4 --- Sandbox Wrapper** {#sub-module-2.4-sandbox-wrapper}

## **6.1 Overview** {#overview-3}
...
## **6.2 In-Memory Compilation Pipeline** {#in-memory-compilation-pipeline}
...
## **6.3 JVM Runtime Configuration** {#jvm-runtime-configuration}
...
## **6.4 Security Hardening Inside the Container** {#security-hardening-inside-the-container}
...
## **7.1 Topic: execution-tasks** {#topic-execution-tasks}
...
## **7.2 Topic: execution-results** {#topic-execution-results}
...
# **8. Redis Key Design** {#redis-key-design}
...
# **9. Java Domain Model** {#java-domain-model}

## **9.1 ExecutionRequest (Gateway Inbound DTO)** {#executionrequest-gateway-inbound-dto}
...
## **9.2 ExecutionTaskEvent (Kafka Message --- execution-tasks)** {#executiontaskevent-kafka-message-execution-tasks}
...
## **9.3 ExecutionResultEvent (Kafka Message --- execution-results / Redis)** {#executionresultevent-kafka-message-execution-results-redis}
...
## **9.4 TestCaseResultEvent** {#testcaseresultevent}
...
## **11.1 Integration with CodeVal Service (Module 1)** {#integration-with-codeval-service-module-1}
...
## **11.2 AWS Managed Service Integration** {#aws-managed-service-integration}
...
# **12. Kubernetes Deployment Baseline** {#kubernetes-deployment-baseline}

## **12.1 Deployment Summary** {#deployment-summary}
...
## **12.2 Horizontal Pod Autoscaler (HPA) Guidance** {#horizontal-pod-autoscaler-hpa-guidance}
...
## **12.3 Node Selection** {#node-selection}
...
## **12.4 Health Probes** {#health-probes}
...
# **13. Operational SLOs and Alerting** {#operational-slos-and-alerting}

## **13.1 Service Level Objectives** {#service-level-objectives}
...
## **13.2 Critical Alerts** {#critical-alerts}
...
# **14. Application Configuration Reference** {#application-configuration-reference}

## **14.1 api-gateway-service (application.yml)** {#api-gateway-service-application.yml}
...
## **14.2 execution-worker-service (application.yml)** {#execution-worker-service-application.yml}
...
## **14.3 result-persistence-service (application.yml)** {#result-persistence-service-application.yml}
...
# **16. Recommended Build Order** {#recommended-build-order}
